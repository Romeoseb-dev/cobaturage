    ...
    <div className="all-descri">
      <div className="description">
        ...
        <p className="text">
          ...
          bord de mon bateau. Profitez de tarifs abordables grâce au cobaturage,
          une option économique et écologique pour explorer les magnifiques eaux
          côtières catalanes. <br />
